...
describe('🧪 Chars in Str tests 🧪', () => {
  describe('charsInString()', () => {
    ...
    it('should return true', () => {
      assert.isTrue(
        charsInString([':', ',', '^', '*'], 'helloworld*', Position.End)
      )
    })

    it('should return true', () => {
      assert.isTrue(
        charsInString([':', ',', '^'], '^helloworld', Position.Start)
      )
    })
    ...
    it('should return false', () => {
      assert.isFalse(
        charsInString([':', ',', '^'], 'hell:oworld', Position.Start)
      )
    })
    ...
    it('should return false', () => {
      assert.isFalse(
        charsInString([':', ',', '^'], 'helloworld^a', Position.End)
      )
    })
    ...
    it('should return true', () => {
      assert.isTrue(
        charsInString(['a', 'H', 'o'], 'helloworld', Position.Any, false)
      )
    })
  })
  ...
  describe('stringsInString()', () => {
    ...
    it('should return true', () => {
      assert.isTrue(
        stringsInString(['abc', 'owom', 'wqp', 'world'], 'helloworld')
      )
    })
