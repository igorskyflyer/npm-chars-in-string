# 🫱🏼‍🫲🏼 Contributing to Chars in String

Thank you for considering a contribution to Chars in String! Whether you're fixing bugs, suggesting improvements, writing docs, or sharing ideas – your input helps the project grow and evolve.
...
- If you're unsure, feel free to open an [`issue`](https://github.com/igorskyflyer/npm-chars-in-string/issues) or discussion to explore the idea.
...
Your contribution helps maintain and improve Chars in String — thank you for helping make it better!  
Check out [`SUPPORT.md`](https://github.com/igorskyflyer/npm-chars-in-string/blob/main/SUPPORT.md) if you need help or want to sponsor its development.
